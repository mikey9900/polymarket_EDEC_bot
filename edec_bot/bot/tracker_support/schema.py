...
CREATE TABLE IF NOT EXISTS decisions (
    ...
    score_time REAL,
    score_balance REAL,
    score_research_flow REAL,
    score_research_crowding REAL,
    resignal_cooldown_s REAL,
    min_price_improvement REAL,
    last_signal_age_s REAL,
    research_cluster_id TEXT,
    research_cluster_n INTEGER DEFAULT 0,
    research_cluster_win_pct REAL,
    research_cluster_avg_pnl REAL,
    research_policy_action TEXT,
    research_market_regime_1d TEXT,
    research_liquidity_score_1d REAL,
    research_crowding_score_1d REAL,
    research_score_flow_1d REAL,
    research_score_crowding_1d REAL,
    research_signal_score_adjustment REAL,
