...
class LiveApiServerTests(unittest.TestCase):
    def test_index_html_renders_runtime_version(self):
        ...
        self.assertIn('data-action="research_set_paper_gate"', html)
        self.assertIn('data-action="research_rollback_last_config"', html)
        self.assertIn('id="proposal-aggr-select"', html)
        self.assertIn('id="live-aggr-select"', html)
        self.assertIn('data-action="research_set_proposal_aggressiveness"', html)
        self.assertIn('data-action="research_set_live_aggressiveness"', html)
        ...
        self.assertIn('TURN GATE OFF', html)
        ...
        self.assertIn('id="codex-gate"', html)
        ...
        self.assertIn('class="research-select-row"', html)
        ...
        self.assertIn("function renderResearchSelect(selectId, level, warn)", html)
        self.assertIn('document.querySelectorAll(".research-select-input[data-action]").forEach((select) => {', html)
        ...
        self.assertNotIn('id="proposal-aggr-slider"', html)
        self.assertNotIn('id="live-aggr-slider"', html)
        self.assertNotIn("function renderResearchSlider(groupId, action, level, warn)", html)
